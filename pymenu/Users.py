...
def view_users():
    ...
    with open("users.txt", "r") as file:
        for line in file:
            p1 = Users(line.split(",")[0], line.split(",")[1], line.split(",")[2], line.split(",")[3], line.split(",")[4])
            print(p1)
    users_menu()
...
def edit_user():
    ...
    if flag == 0:
        ...
        choice = input()
        if choice == "y":
            print("which part of the user's information do you want to change?")
            choice2 = input()
            ...
            if choice2 == "password":
                ...
                print("Invalid choice")
            list_of_lines[
                index - 1] = p1.password + "," + p1.email + "," + p1.first_name + "," + p1.last_name + "," + p1.tlf + "\n"
